...
const Payment = ({ order, clearOrder, clientName, selectedTable }) => {
  ...
  const finalTotal = splitBill
    ? (totalWithDiscount / splitValue).toFixed(2)
        ...
        <>
          <div className="mb-4">
            <input
              ...
              className="mr-2"
            />
            <label>¿Desea dividir la cuenta?</label>
          </div>
          {splitBill && (
            <div className="mb-4">
              <label
                    ...
                    onChange={(e) => {
                      ...
                      if (value.length > 2) {
                        const month = Math.min(
                          12,
                          Math.max(0, parseInt(value.slice(0, 2)))
                        ); // Asegurarse de que el mes esté entre 00 y 12
            ...
            <div className="text-center">
              {paymentStatus === "success" ? (
                <div className="flex flex-col justify-center items-center">
                  ...
                  {paymentMethod === "cash" ? (
                    <p>Pronto llegara un mesero con su cuenta.</p>
                  ) : (
